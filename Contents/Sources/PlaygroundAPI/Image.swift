...
///   - `contentMode` Controls the way the image scales to fill it's size.
...
///
/// Here are some additional properties that affect the Image:
///
...
public class Image: AbstractDrawable {
    ...
    /// Controls the way the image scales to fill it's size.
    ...
    /// When set to a non-nil value, parts of the image with an alpha value of 1.0 are filled with the tint color, while parts of the image with an alpha of less than 1.0 get treated as completely transparent.
    ...
    ///
    ///   - `name` The name of the image resource to create the image from.
    ///   - `tint` When set to a non-nil value, parts of the image with an alpha value of 1.0 are filled with the tint color, while parts of the image with an alpha of less than 1.0 get treated as completely transparent.
    ///   - `contentMode` Controls the way the image scales to fill it's size.
    ...
    /// Creates an image centered on the canvas.
    ///
    ///   - `url` The URL to create an image from.
    ///   - `tint` When set to a non-nil value, parts of the image with an alpha value of 1.0 are filled with the tint color, while parts of the image with an alpha of less than 1.0 get treated as completely transparent.
    ///   - `contentMode` Controls the way the image scales to fill it's size.
...
public enum ImageContentMode {
    /// Both scale and stretch the image when it's natural size doesn't match the size it is being set to.
    case scaleAndStretchToFill
    /// Only scale and don't stretch the image when it's natural size doesn't match the size it is being set to.
    case scaleToFitMaintainingAspectRatio
}
