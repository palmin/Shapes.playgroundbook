...
///
/// Here are some additional properties that affect the Text:
///
...
public class Text: AbstractDrawable {
    ...
    public init(string: String, fontSize: Double = DefaultFontSize, fontName: String = "", color: Color = .black) {
        ...
        // NOTE (ken orr): we'll update our size below as a result of calling udpateBackingViewSizeFromFont().
