...
//  Drawing
//
//  Created by Sam Page on 4/13/16.
...
///   - `thickness` The thicknes of the line. The default is 0.5.
///
/// Here are some additional properties that affect the Line:
///
...
public class Line: Shape {
    ...
    /// The thicknes of the line. The default is 0.5.
